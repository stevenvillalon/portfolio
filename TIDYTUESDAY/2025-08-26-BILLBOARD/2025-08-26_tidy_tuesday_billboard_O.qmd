...
```{python exploration}
mixed_df = billboard[(billboard['artist_gender'] == "Mix") & (billboard['decade'] == '2000s')]
...
```{python visualization, echo=FALSE, fig.height=5, fig.width=7, message=FALSE, echo=FALSE}
...
plt.figtext(0.5, 0.02, 'Chart produced by Steven Villalon for Tidy Tuesday exercise on August 26, 2025.', 
            ha='center', fontsize=11, wrap=False)
